    ...
    <div className="w-full h-full flex flex-col animate-fade-in">
      ...
      <div className="flex justify-center pt-4 px-4 flex-shrink-0">
        ...
        >
          ...
          {/* Progress arc — fills as thumbs-up is held */}
          <svg
          ...
          {/* Gesture badge */}
          <div className="absolute bottom-3 right-3 w-12 h-12 rounded-full border border-primary/25 bg-black/40 flex items-center justify-center">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-4 px-8">
        {isLoading ? (
          <p className="text-primary/40 text-xs tracking-widest uppercase">Initializing...</p>
        ) : (
          <>
            <h2 className="font-display text-3xl font-normal text-primary">
              {isHolding ? "Hold it..." : "Ready?"}
            </h2>
            <p className="text-primary/55 text-sm leading-relaxed text-center max-w-xs">
